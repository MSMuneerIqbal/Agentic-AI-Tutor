              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-primary-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="font-medium text-gray-900">Your Study Plan</h3>
                      <p className="text-sm text-gray-600">AI-generated personalised learning roadmap</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="text-sm font-medium text-primary-600">In Progress</div>
                    <div className="text-xs text-gray-500">{user?.progress || 0}% Complete</div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="font-medium text-gray-900">Advanced Topics</h3>
                      <p className="text-sm text-gray-600">Deep dives unlocked as you progress</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="text-sm font-medium text-gray-500">Locked</div>
                    <div className="text-xs text-gray-500">Complete your study plan first</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="card">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  { name: 'AI & Machine Learning', members: 24, level: 'Beginner' },
                  { name: 'Advanced Learners', members: 18, level: 'Advanced' },
                  { name: 'General Study Group', members: 32, level: 'Intermediate' },
                ].map((group, index) => (
