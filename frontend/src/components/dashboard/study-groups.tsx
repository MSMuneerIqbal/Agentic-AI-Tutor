  ...
  const groups = [
    {
      ...
      description: 'Learning AI and ML concepts together',
      members: 24,
      activeMembers: 8,
    ...
    },
    {
      ...
      description: 'Deep dives into advanced topics',
      members: 18,
      activeMembers: 5,
    ...
    },
    {
      ...
      description: 'Open discussion and knowledge sharing',
      members: 45,
      activeMembers: 12,
        ...
        {groups.map((group, index) => (
          <motion.div
            ...
            className={`p-4 rounded-lg border ${
              group.isJoined ? 'border-primary-200 bg-primary-50' : 'border-gray-200 bg-white'
            }`}
          >
            <div className="flex items-start justify-between mb-3">
              ...
              <span className={`badge ${getLevelColor(group.level)}`}>{group.level}</span>
            </div>
            ...
            <div className="flex items-center justify-between">
              <button className={`btn text-sm ${group.isJoined ? 'btn-secondary' : 'btn-primary'}`}>
