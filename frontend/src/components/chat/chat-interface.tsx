  ...
  useEffect(() => {
    if (messages.length === 0) {
      const welcomeMessage: Message = {
        id: 'welcome',
        content: `Welcome to Tutor GPT, ${user?.name || 'Student'}! I'm your AI tutor and I'm here to guide your learning journey. I can teach any subject using your personal knowledge base, assess your learning style, create study plans, quiz you, brainstorm ideas with you, and track your progress. What would you like to learn today?`,
        sender: 'agent',
        ...
        <div className="flex items-end space-x-3">
          <div className="flex-1">
            <textarea
              ...
              placeholder="Ask me anything — I'll teach, quiz, or brainstorm with you..."
