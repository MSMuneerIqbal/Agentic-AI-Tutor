    ...
    async def create_study_plan(
        ...
        try:
            ...
            plan = {
                ...
                "summary": plan_data.get("summary", f"Study plan for {plan_data.get('topics', ['General topics'])[0]}"),
                "topics": plan_data.get("topics", []),
                "learning_style": plan_data.get("learning_style", "visual"),
                "estimated_hours": plan_data.get("estimated_hours", 10),
                "created_at": datetime.utcnow().isoformat(),
                "updated_at": datetime.utcnow().isoformat(),
                "topic_count": len(plan_data.get("topics", [])),
                "total_hours": plan_data.get("estimated_hours", 10)
            }
