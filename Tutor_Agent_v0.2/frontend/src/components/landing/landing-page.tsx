          ...
          <div className="text-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
                Master{' '}
                <span className="text-gradient">Docker & Kubernetes</span>
                <br />
                with AI Tutors
              </h1>
              
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Learn cloud-native technologies with personalized AI agents, collaborative learning, 
                and real-time feedback. Transform your DevOps skills with the most advanced tutoring system.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
              Join thousands of students who are already mastering Docker and Kubernetes with AI-powered tutoring.
            </p>
            <button
              onClick={() => setShowRegister(true)}
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                AI-powered learning platform for Docker and Kubernetes mastery.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-white">Docker Basics</a></li>
                <li><a href="#" className="hover:text-white">Kubernetes Fundamentals</a></li>
                <li><a href="#" className="hover:text-white">Advanced Topics</a></li>
                <li><a href="#" className="hover:text-white">Certification Prep</a></li>
              </ul>
            </div>
